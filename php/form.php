<?php
$recipient = 'info@sayze.cl'; // Enter the recipient's email address here.
$subject   = 'Corre enviado desde el sitio web de Sayze.'; // Enter the subject of the email here.
$success   = 'Tu mensaje ha sido enviado correctamente. Gracias.';
$error     = 'Lo sentimos. No se ha podido enviar tu correo.';
$invalid   = 'Error de validación. Revisa los campos y vuelve a intentar.';
